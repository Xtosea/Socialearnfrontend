...
export default function WatchInstagramPromo() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const res = await api.get("/tasks/promoted/instagram");
        setVideos(res.data || []);
        const timers = {};
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      <h2 className="text-2xl font-bold mb-4">Promoted WatchInstagramPromo</h2>
      {videos.length ? (
        videos.map(v => (
