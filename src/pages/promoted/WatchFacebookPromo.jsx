...
export default function WatchFacebookPromo() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const res = await api.get("/tasks/promoted/facebook");
        setVideos(res.data || []);
        const timers = {};
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      <h2 className="text-2xl font-bold mb-4">Promoted WatchFacebookPromo</h2>
      {videos.length ? (
        videos.map(v => (
